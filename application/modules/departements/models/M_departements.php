...
class M_departements extends CI_Model
{
  ...
  public function list_data($cookie)
  {
    ...
    $sql = "SELECT * FROM departements a 
      $where
      ORDER BY "
  ...
  public function all_data()
  {
    ...
    $sql = "SELECT * FROM departements a $where ORDER BY created_at";
    $query = $this->db->query($sql);
    return $query->result_array();
  }
  ...
  public function all_rows($cookie)
  {
    ...
    $sql = "SELECT COUNT(1) as total FROM departements a $where";
    $query = $this->db->query($sql);
  ...
  {
    $sql = "SELECT * FROM departements WHERE $field = ?";
  ...
  public function save($data, $id = null)
  {
    if ($id == null) {
      ...
      $this->db->where('departement_id', $id)->update('departements', $data);
    }
  }
  ...
  {
    if ($permanent) {
      $this->db->where('departement_id', $id)->delete('departements');
    } else {
      $data['is_deleted'] = 1;
      $data['updated_at'] = date('Y-m-d H:i:s');
      $data['updated_by'] = $this->session->userdata('user_fullname');
