          ...
          <div class="card">
            ...
            <form id="form" action="<?= site_url() . '/' . $menu['controller'] . '/save/' . $id ?>" method="post" autocomplete="off" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <input type="hidden" class="form-control form-control-sm" name="family_status_id" id="family_status_id" value="<?= @$main['family_status_id'] ?>" required>
                <?php if ($id != null) : ?>
                  <input type="hidden" class="form-control form-control-sm" name="old" id="old" value="<?= @$main['family_status_name'] ?>" required>
                <?php endif; ?>
