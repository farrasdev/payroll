          ...
          <div class="card">
            ...
            <form id="form" action="<?= site_url() . '/' . $menu['controller'] . '/save/' . $id ?>" method="post" autocomplete="off" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <input type="hidden" class="form-control form-control-sm" name="coeficient_all_id" id="coeficient_all_id" value="<?= @$main['coeficient_all_id'] ?>" required>
                <?php if ($id != null) : ?>
                  <input type="hidden" class="form-control form-control-sm" name="old" id="old" value="<?= @$main['coeficient_all_id'] ?>" required>
                <?php endif; ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control form-control-sm datepicker" name="coeficient_all_date" id="coeficient_all_date" value="<?= @reverse_date($main['coeficient_all_date']) ?>" required>
                  </div>
                </div>
                <div class="form-group row">
      ...
      rules: {
        coeficient_all_id: {
          remote: {
            ...
            data: {
              'coeficient_all_id': function() {
                return $('#coeficient_all_id').val();
              }
            },
            dataType: 'json'
          }
