...
class Salary_status extends MY_Controller
{
  ...
  function __construct()
  {
    ...
    if ($this->cookie['order'] == null) $this->cookie['order'] = array('field' => 'salary_status_id', 'type' => 'asc');
  ...
  public function save($id = null)
  {
    ...
    $cek = $this->m_salary_status->by_field('salary_status_id', $data['salary_status_id']);
    if ($id == null) {
      if ($cek != null) {
      ...
      if ($data['old'] != $data['salary_status_id'] && $cek != null) {
        $this->session->set_flashdata('flash_error', 'Kode sudah ada di sistem.');
  ...
  public function ajax($type = null, $id = null)
  {
    if ($type == 'check_id') {
      ...
      if ($id == null) {
        ...
        echo ($id != $data['salary_status_id'] && $cek != null) ? 'false' : 'true';
      }
    }
  }
}
