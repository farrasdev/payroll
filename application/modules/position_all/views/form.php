          ...
          <div class="card">
            ...
            <form id="form" action="<?= site_url() . '/' . $menu['controller'] . '/save/' . $id ?>" method="post" autocomplete="off" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <input type="hidden" class="form-control form-control-sm" name="position_all_id" id="position_all_id" value="<?= @$main['position_all_id'] ?>" required>
                <?php if ($id != null) : ?>
                  <input type="hidden" class="form-control form-control-sm" name="old" id="old" value="<?= @$main['position_all_id'] ?>" required>
                <?php endif; ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-2">
                    <input type="text" class="form-control form-control-sm datepicker" name="position_all_date" id="position_all_date" value="<?= @reverse_date($main['position_all_date']) ?>" required>
                  </div>
                </div>
                <div class="form-group row">
      ...
      rules: {
        position_all_id: {
          remote: {
            ...
            data: {
              'position_all_id': function() {
                return $('#position_all_id').val();
              }
            },
            dataType: 'json'
          }
