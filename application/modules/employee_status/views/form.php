          ...
          <div class="card">
            ...
            <form id="form" action="<?= site_url() . '/' . $menu['controller'] . '/save/' . $id ?>" method="post" autocomplete="off" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <?php if ($id != null) : ?>
                  <input type="hidden" class="form-control form-control-sm" name="old" id="old" value="<?= @$main['employee_status_id'] ?>" required>
                <?php endif; ?>
                <div class="form-group row">
                  <label for="menu" class="col-sm-2 col-form-label text-right">Kode <span class="text-danger">*</span></label>
                  <div class="col-sm-2">
                    <input type="text" class="form-control form-control-sm" name="employee_status_id" id="employee_status_id" value="<?= @$main['employee_status_id'] ?>" required>
                  </div>
                </div>
                <div class="form-group row">
      ...
      rules: {
        employee_status_id: {
          remote: {
            ...
            data: {
              'employee_status_id': function() {
                return $('#employee_status_id').val();
              }
            },
            dataType: 'json'
          }
